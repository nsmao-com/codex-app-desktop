...
const AppVersionFallback = '1.5.11'
...
export const useAppStore = defineStore('app', () => {
  ...
  const appVersion = shallowRef('1.5.11')
  ...
  function applyBootstrap(data: BootstrapData): void {
    ...
    settings.value = {
      ...
      geminiEffort: data.settings.geminiEffort || 'high',
  ...
  function mergeSavedSettings(saved: UserSettings, next: UserSettings): UserSettings {
    ...
    return {
      ...
      geminiEffort: saved.geminiEffort || next.geminiEffort || 'high',
